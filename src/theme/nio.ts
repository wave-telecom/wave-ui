  ...
  palette: {
    dark: {
      surface: {
        ...
        'primary-defaultSubtleHoverAlt': { color: 'primary', scale: 1200 },
        'secondary-default': { color: 'secondary', scale: 500 },
        'secondary-defaultHover': { color: 'secondary', scale: 400 },
        'secondary-defaultSubtle': { color: 'secondary', scale: 1100 },
        'secondary-defaultSubtleHover': { color: 'secondary', scale: 1200 },
      ...
      text: {
        ...
        'secondary-onColorSubtle': { color: 'secondary', scale: 100 },
